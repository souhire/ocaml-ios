...
./configure -verbose -prefix $TOOLCHAIN/tests/3.12.1-ios -host arm-apple-darwin11  -cc "$ACC" -as "$ACC -c" -aspp "$ACC -c" -partialld "arm-apple-darwin11-ld -r";
make world;
make opt;
sudo make install;
